    ...
    return (
      <View style={styles.mainView}>
        ...
        <View style={{width: "75%", flexDirection: "row", justifyContent: "space-around", marginTop: 10}}>
          <TouchableImage source={require("../img/arrow_small.png")} style={{ width: 20, height: 40,
            shadowColor: '#000',
            shadowOffset: { width: 0, height: 2 },
            shadowOpacity: 0.3,
            shadowRadius: 1,  }} onPress={this.selectPrevious.bind(this)}/>
          ...
          <TouchableImage source={require("../img/arrow_small.png")} style={{ width: 20, height: 40, transform: [{scaleX: -1}],
            shadowColor: '#000',
            shadowOffset: { width: 0, height: 2 },
            shadowOpacity: 0.3,
            shadowRadius: 1,} } onPress={this.selectNext.bind(this)}/>
        </View>

        <View style={{ width: "100%", justifyContent: "center", alignItems: "center", marginTop: 50 }}>
          <PaginationIndicator amount={3} indexSelected={this.state.indexSelected} style={{ justifyContent: "center", alignItems: "center" }} />
        </View>

        <View style={{ width: "75%", height: 110, justifyContent: "space-between", marginTop: 60 }}>
          <View style={{flexDirection: "row", justifyContent: "space-between"}}><Text style={{ fontSize: 19, fontFamily: "Lato-Light"}}>Total Workouts</Text> <Text style={{ fontSize: 19 }}>15</Text></View>
          <View style={{flexDirection: "row", justifyContent: "space-between"}}><Text style={{ fontSize: 19, fontFamily: "Lato-Light" }}>Average Time</Text> <Text style={{ fontSize: 19 }}>01:08</Text></View>
          <View style={{flexDirection: "row", justifyContent: "space-between"}}><Text style={{ fontSize: 19, fontFamily: "Lato-Light" }}>Last Time</Text> <Text style={{ fontSize: 19 }}>00:45</Text></View>
        </View>

        <View style={{ width: "75%", height: 120, marginTop: 50 }}>
          <Button text={startWorkout} backgroundColor={"black"} color={"white"} padding={15} borderRadius={10} fontSize={19} fontWeight={"bold"} onPress={() => this.handleClick(this.state.regions[this.state.indexSelected])} style={{
            shadowColor: '#000',
            shadowOffset: { width: 0, height: 2 },
            shadowOpacity: 0.8,
            shadowRadius: 2,  }}/>
